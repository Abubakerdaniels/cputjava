 ...
 * @author Wallied
 */
public class StoreCustomerFactory  implements PersonFactory
{
       private  static  StoreCustomerFactory  storeCustomerFactory=null;
    
       private StoreCustomerFactory()
       {
        
       }
       public   static  StoreCustomerFactory   getInstance()
       {
            if(storeCustomerFactory==null)
            {
                
                storeCustomerFactory=new StoreCustomerFactory();
            }
            return  storeCustomerFactory;
